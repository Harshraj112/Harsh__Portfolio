  ...
  var It,
      ...
      if (
        ...
        for (
          ...
          if (
            ...
            for (n in r)
              ht[n] && (f = Lb(n, r, t, c, o, D))
                ? f.priority && (u = 1)
                : (d[n] = a =
                    Lt.call(t, o, n, "get", r[n], c, D, 0, _.stringFilter));
    ...
    Ht = (function (D) {
      function Tween(t, e, i, n) {
          ...
          if (
            ...
            for (h = 0; h < f; h++) {
              ...
              (l.stagger = 0),
                ...
                (l.delay =
                  (+Yt(y, _assertThisInitialized(a), h, c, A) || 0) - a._delay),
                !b &&
                  1 === f &&
                  l.delay &&
        ...
        return (
          !0 === w &&
            ((It = _assertThisInitialized(a)), F.killTweensOf(A), (It = 0)),
    ...
    if (e.tween && e.tween._time === e.tween._dur) {
      ...
      if ("all" === o || !0 === o) (s.cssText = ""), (i = 1);
        ...
        for (n = (o = o.split(",")).length; -1 < --n; )
          (r = o[n]),
            Ae[r] && ((i = 1), (r = "transformOrigin" === r ? qe : Le)),
            pd(a, r);
      i &&
        (pd(a, Le),
        u &&
  ...
  function Dd(t, e) {
    ...
    return s.svg && t.getAttribute("transform")
      ...
      : (u !== Ve ||
          ...
          ((n = o.display),
          (o.display = "block"),
          ((r = t.parentNode) && ae.body.contains(t)) ||
