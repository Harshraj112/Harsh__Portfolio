...
!(function (e, t) {
  ...
  function E(e, t) {
    ...
    return (r = "scroll" + n) && C(e)
      ? Math.max(x[r], Te[r]) -
          (xe["inner" + n] || x["client" + n] || Te["client" + n])
      : e[r] - e["offset" + n];
  }
  function F(e) {
  ...
  function Ja(e, t, r, n, o, i, a, s, l, c, f, u) {
    ...
    if (i) {
      ...
      (u = "scroll" + n.d2),
        ...
        f &&
          ((l = ea(a)),
          f && (i.style[n.op.p] = l[n.op.p] - n.op.m - i._offset + We));
    }
    return Math.round(e);
  }
  function Ma(l, e) {
  ...
  var ye,
    ...
    qe = {
      ...
      sc: function sc(e) {
        return arguments.length
          ? xe.scrollTo(e, Je.sc())
          : xe.pageXOffset || we[t] || x[t] || Te[t] || 0;
      },
    },
    Je = {
      s: r,
      ...
      sc: function sc(e) {
        return arguments.length
          ? xe.scrollTo(qe.sc(), e)
          : xe.pageYOffset || we[r] || x[r] || Te[r] || 0;
      },
    },
    Xe = {
      startColor: "green",
    ...
    m = function _updateAll() {
      ...
      for (
        n &&
        (Oe && !Ee && 200 < r - Oe && ((Oe = 0), v("scrollEnd")),
        (ke = u),
        (u = r));
        t < e;
        t++
  ...
  qe.op = Je;
  var _ =
    ((ScrollTrigger.prototype.init = function init(h, v) {
      if (((this.progress = 0), this.vars && this.kill(1), ze)) {
        var d,
          ...
          V,
          Z,
          $ = (h = da(F(h) || H(h) || h.nodeType ? { trigger: h } : h, Ye))
            .horizontal
            ? qe
            : Je,
          K = h.onUpdate,
        ...
        (ae *= 45),
          ...
          (ve.tweenTo = d = l.tweenScroll[$.p]),
          v &&
            ((v.vars.lazy = !1),
            v._initted ||
              (!1 !== v.vars.immediateRender && v.render(0, !0, !0)),
            (ve.animation = v.pause()),
            (v.scrollTrigger = ve),
            (o = H(a) && a) &&
              (U = ye.to(v, {
                ease: "power3",
          ...
          le &&
            ...
            (c = G(le.snapTo)
              ...
              : ye.utils.snap(le.snapTo)),
            (f = le.duration || { min: 0.1, max: 2 }),
            (f = I(f) ? Ce(f.min, f.max) : Ce(f, f)),
            (V = ye
              .delayedCall(le.delay || o / 2 || 0.1, function () {
                if (!Oe || (Oe === Y && !Ee)) {
                  ...
                  if (a <= x && y <= a) {
                    ...
                    d(
                      s,
                      {
                        ...
                        data: Math.abs(s - a),
                        onComplete: function onComplete() {
                          (J = X = v && !fe ? v.totalProgress() : ve.progress),
                            u && u(ve);
                        },
                      },
                      y + e * _,
              ...
              .pause())),
          i && (Ve[i] = ve),
          (re = ve.trigger = Se(re || ne)[0]),
          (ne = !0 === ne ? re : Se(ne)[0]),
          F(Q) && (Q = { targets: re, className: Q }),
          ne &&
            (!1 === oe ||
              oe === Re ||
              (oe = "flex" !== ba(ne.parentNode).display && Ne),
            (ve.pin = ne),
            !1 !== h.force3D && ye.set(ne, { force3D: !0 }),
            (e = ye.core.getCache(ne)).spacer
              ? (M = e.pinState)
              : ((e.spacer = A = we.createElement("div")),
                A.setAttribute(
                  "class",
                  "pin-spacer" + (i ? " pin-spacer-" + i : "")
                ),
                (e.pinState = M = Ga(ne))),
            (ve.spacer = A = e.spacer),
            (n = ba(ne)),
            (R = n[oe + $.os2]),
            (L = ye.getProperty(ne)),
            (B = ye.quickSetter(ne, $.a, We)),
            Da(ne, A, n),
            (O = Ga(ne))),
          p &&
            ((t = I(p) ? da(p, Xe) : Xe),
            (S = oa("scroller-start", i, ue, $, t, 0)),
            (k = oa("scroller-end", i, ue, $, t, 0, S)),
            (r = S["offset" + $.op.d2]),
            (w = oa("start", i, ue, $, t, r)),
            (T = oa("end", i, ue, $, t, r)),
            pe ||
              ...
              ye.set([S, k], { force3D: !0 }),
              (W = ye.quickSetter(S, $.a, We)),
              (q = ye.quickSetter(k, $.a, We)))),
          (ve.revert = function () {
            ve.update(1), ne && Ca(ne, A, M), (m = 1);
          }),
          (ve.refresh = function (e) {
            if (!_e && Z)
              if (ne && e && Oe) ia(ScrollTrigger, "scrollEnd", me);
              else {
                var t = ve.scroll(),
                  r = ve.progress;
                (_e = 1),
                  U && U.kill(),
                  ie && v && v.progress(0).invalidate().progress(ve.progress),
                  m || ve.revert();
                var n,
                  o,
                  i,
                ...
                if (
                  ((y =
                    Ja(g, re, l, $, ve.scroll(), w, S, ve, c, he, pe, f) ||
                    (ne ? -0.001 : 0)),
                  G(p) && (p = p(ve)),
                  F(p) &&
                    !p.indexOf("+=") &&
                  ...
                  (n = ba(ne)),
                    ...
                    pe &&
                      (((s = {
                        ...
                        Math.ceil(o.width) + We),
                      (s[Ie] = s["max" + He] = Math.ceil(o.height) + We),
                      (s[Re] =
                        s[Re + Be] =
                        s[Re + Le] =
                        s[Re + Ge] =
                ...
                else if (re && ve.scroll())
                  for (o = re.parentNode; o && o !== Te; )
                    o._pinOffset && ((y -= o._pinOffset), (x -= o._pinOffset)),
                      (o = o.parentNode);
                (ve.start = y),
                  (ve.end = x),
                  ve.scroll() < t && ve.scroll(t),
                  ve.update(),
                  (_e = m = 0),
                  r !== ve.progress &&
                    (U && v.totalProgress(r, !0),
                    (ve.progress = r),
                    ve.update()),
                  ne && oe && (A._pinOffset = Math.round(ve.progress * _)),
                  te && te(ve);
              }
          }),
          ...
          (ve.update = function (e, t) {
            ...
            if (
              (t &&
                ((b = g),
                (g = s),
                le && ((X = J), (J = v && !fe ? v.totalProgress() : c))),
              ae &&
                !c &&
                ne &&
                !_e &&
              ...
              if (
                ((i =
                  (a = (r = ve.isActive = !!c && c < 1) != (!!f && f < 1)) ||
                  !!c != !!f),
                (ve.direction = f < c ? 1 : -1),
                (ve.progress = c),
                ne)
              )
                if ((e && oe && (A.style[oe + $.os2] = R), pe)) {
                  if (i) {
                    if (((o = s + 1 >= E(ue, $)), ce)) {
                      if (!_e && (r || o)) {
                        var u = ea(ne, !0),
                          p = s - y;
                        (ne.style.top = u.top + ($ === Je ? p : 0) + We),
                          (ne.style.left = u.left + ($ === Je ? 0 : p) + We);
                      }
              ...
              fe ||
                (!U || _e || Me
                  ? v && v.totalProgress(c, !!_e)
                  : ((U.vars.totalProgress = c), U.invalidate().restart()),
                K && !e && K(ve)),
                !le || d.tween || _e || Me || ((Y = Oe), V.restart(!0)),
                i && !_e
                  ? ((n =
                      c && !f && c < 1
                        ? 0
                    ...
                    1 === c && se
                      ...
                      : fe &&
                        ((o = ge[n]),
                        v &&
                          ("complete" === o || "reset" === o || o in v) &&
                          ("complete" === o
                            ? v.pause().totalProgress(1)
                            : "reset" === o
                            ? v.restart(!0).pause()
                            : v[o]()),
                        K && K(ve)),
                    Q &&
                      a &&
                      Se(Q.targets).forEach(function (e) {
                        return e.classList.toggle(Q.className);
                      }),
                    ee && a && ee(ve),
                    de[n] && de[n](ve),
                    se && (de[n] = 0),
                    a || (de[(n = 1 === c ? 1 : 3)] && de[n](ve)))
                  : fe && K && !_e && K(ve);
            }
          ...
          (ve.enable = function () {
            Z ||
              ...
              ia(ue, "resize", ua),
              ia(ue, "scroll", ta),
              be && ia(ScrollTrigger, "refreshInit", be),
              v && (v.add ? ye.delayedCall(0.01, ve.refresh) : ve.refresh()));
          }),
          (ve.disable = function (e) {
            if (
              Z &&
              (e !== (Z = ve.isActive = !1) && ve.update(1),
              ne && Ca(ne, A, M),
              be && ja(ScrollTrigger, "refreshInit", be),
              !pe)
            ) {
    ...
    (ScrollTrigger.register = function register(e) {
      if (
        ...
        A() &&
          ...
          ((xe = window),
          (we = document),
          (x = we.documentElement),
          (Te = we.body)),
        ye &&
          ((Se = ye.utils.toArray),
          (Ce = ye.utils.clamp),
          ye.core.globals("ScrollTrigger", ScrollTrigger),
          Te))
      ) {
        (s =
        ...
        (r.borderTop = "1px solid #000"),
          (t = ea(Te)),
          (Je.m = Math.round(t.top + Je.sc()) || 0),
          (qe.m = Math.round(t.left + qe.sc()) || 0),
          ...
          ia(we, "touchcancel", z),
          ia(Te, "touchstart", z),
          ha(ia, we, "pointerdown,touchstart,mousedown", function () {
            return (Ee = 1);
          }),
          ha(ia, we, "pointerup,touchend,mouseup", function () {
            return (Ee = 0);
          }),
          (f = ye.utils.checkPrefix("transform")),
          S.push(f),
          (o = Pe()),
          (a = ye.delayedCall(0.2, ya).pause()),
          ia(we, "visibilitychange", function () {
            return we.hidden || ya();
          }),
          ia(we, "DOMContentLoaded", ya),
          ia(xe, "load", function () {
            return Oe || ya();
          }),
          ia(xe, "resize", ua);
